...
$string['hint'] = 'Instrucciones para resolver el ejercicio';
$string['solution'] = 'Solución';
$string['resultdata'] = 'Script para el Result Data';
$string['subjectivedifficulty'] = 'Dificultad subjetiva';
$string['objectivedifficulty'] = 'Dificultad objetiva';
$string['error_resultdata_empty'] = 'El campo result data field no puede estar vacío.';
...
$string['statement_hint'] = 'Instrucciones para resolver el ejercicio:';
...
$string['statement_objectivedifficulty'] = 'Dificultad ojetiva del ejercicio:';
$string['statement_solution'] = 'Solución del ejercicio:';
$string['data_no_present'] = 'Script no presente.';
$string['hint_no_present'] = 'Instrucciones no presentes.';
...
$string['objectivedifficulty_no_present'] = 'Dificultad ojetiva no presente.';
